...
const (
	TypeAdvantageStrong = "TypeAdvantageStrong"
	TypeAdvantageWeak   = "TypeAdvantageWeak"
	TypeAdvantageNormal = "TypeAdvantageNormal"
	TypeAdvantageNone   = "TypeAdvantageNone"
)

func getTypeAdvantage(atk pokemon.Type, def pokemon.Type) string {
	switch atk {
